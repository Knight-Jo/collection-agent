      ...
      events={[
        {
          ...
          data: envelope(
            ...
            1,
            {
              ...
              reason_summary: "关键问题覆盖不足",
              state_snapshot: { gap_score: 3 },
            },
            1,
          ),
        },
        {
          ...
          data: envelope("action", 1, { action_id: "act-1", tool: "web_search" }, 2),
        },
        {
          id: 3,
          type: "trajectory.state_updated",
          timestamp: "2026-08-11T09:00:02Z",
          data: envelope(
            "state_updated",
            1,
            { state_scope: "task", delta: { search_attempts: { before: 0, after: 1 } } },
            3,
          ),
        },
      ]}
...
it("shows an empty state when there are no trajectory events", () => {
  render(
    <DecisionTrace
      events={[{ id: 1, type: "run.started", timestamp: "2026-08-11T09:00:00Z", data: {} }]}
    />,
  );
