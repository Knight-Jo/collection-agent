    ...
    <RunTimeline
      events={[
        { id: 1, type: "run.started", timestamp: "2026-08-11T09:00:00Z", data: {} },
        {
          ...
          data: { task_id: "task-1", stage: "collect" },
        },
      ]}
    />,
  );
    ...
    <RunTimeline
      events={[
        { id: 1, type: "crawl.started", timestamp: "2026-08-11T09:00:00Z", data: {} },
        {
          ...
          type: "crawl.progress",
          timestamp: "2026-08-11T09:00:01Z",
          data: { counts: { queued: 2, complete: 1, reused: 0 } },
        },
        {
          id: 3,
          type: "crawl.resource",
          timestamp: "2026-08-11T09:00:02Z",
          data: { resource: { canonical_url: "https://example.com/a" } },
        },
    ...
    <RunTimeline
      events={[
        ...
        },
        {
          ...
          type: "crawl.resource",
          timestamp: "2026-08-11T09:00:01Z",
          data: { resource: { status: "skipped_robots" } },
        },
      ]}
    />,
  );
